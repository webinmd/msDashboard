...
class msDashboardItemUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('msdashboard_item_err_ns');
        }
...
return 'msDashboardItemUpdateProcessor';
